...
class Users extends Component {
    ...
    addUser(e) {
        e.preventDefault();
        axios.post('http://192.168.1.12:8000/api/users/', this.state.newUserData).then((response) => {
    ...
    updateUser(e) {
        ...
        axios.put('http://192.168.1.12:8000/api/users/' + this.state.editUserData.id, {
            role, name, email
        }).then((response) => {
            this._refreshUsers();
    ...
    deleteUser(id) {
        axios.delete('http://192.168.1.12:8000/api/users/' + id).then((response) => {
            this._refreshUsers();
        });
    }

    deleteUser1 = async (id) => {
        await axios.delete('http://192.168.1.12:8000/api/users/' + id);
        this._refreshUsers();
    }

    _refreshUsers() {
        axios.get('http://192.168.1.12:8000/api/users/').then((response) => {

                ...
                <header className="main-header">
                    ...
                    <nav className="navbar navbar-static-top">
                        ...
                        <small><i className="fa fa-clock-o" /> 2 days</small>
                                        ...
                                        <li className="footer"><a href="take_url">See All Messages</a></li>
                                    </ul>
                                </li>
                                ...
                                <li className="dropdown notifications-menu">
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li className="footer"><a href="take_url">View all</a></li>
                                    </ul>
                                </li>
                        ...
                        <small className="pull-right">80%</small>
                                        ...
                                        <li className="footer">
                                            <a href="take_url">View all tasks</a>
                                        </li>
                                    </ul>
                                </li>
                                        ...
                                        <li className="user-body">
                                            <div className="row">
                                                <div className="col-xs-4 text-center">
                                                    <a href="take_url">Followers</a>
                                                </div>
                                                <div className="col-xs-4 text-center">
                                                    <a href="take_url">Sales</a>
                                                </div>
                                                <div className="col-xs-4 text-center">
                                                    <a href="take_url">Friends</a>
                                                </div>
                                            </div>
                                            {/* /.row */}
                                        </li>
